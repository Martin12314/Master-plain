...
<script type="module">
    ...
    document.getElementById('sendBtn').addEventListener('click', async () => {
      ...
      if (headers['X-Enc-X-Custom']) {
        pageLog('Header X-Enc-X-Custom:', 'JWE ' + maybeShort(headers['X-Enc-X-Custom']));
      }
      ...
      pageLog('Response HTTP', r.status, r.statusText);
